export const TRAMITES = [
  {
    ...
    forms: [
      { name: 'Formulario EX-01', url: 'https://extranjeros.inclusion.gob.es/es/ModelosSolicitudes/Mod_solicitudes2/01-Formulario_solicitud_AE_Residencia_temporal.pdf' },
      { name: 'Tasa modelo 790 código 052', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/tasa790' }
    ],
    where: [
  ...
  },
  {
    ...
    forms: [
      { name: 'Formulario EX-17', url: 'https://extranjeros.inclusion.gob.es/es/ModelosSolicitudes/Mod_solicitudes2/17-Formulario_renovacion_residencia.pdf' },
      { name: 'Tasa modelo 790 código 012', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/tasa790' }
    ],
    where: [
  ...
  },
  {
    ...
    forms: [
      { name: 'Formulario EX-02', url: 'https://extranjeros.inclusion.gob.es/es/ModelosSolicitudes/Mod_solicitudes2/02-Formulario_solicitud_reagrupacion_familiar.pdf' }
    ],
    where: [
      { name: 'Oficina de Extranjería de Barcelona', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
    ],
  ...
  },
  {
    ...
    forms: [
      { name: 'Formulario EX-15', url: 'https://extranjeros.inclusion.gob.es/es/ModelosSolicitudes/Mod_solicitudes2/15-Formulario_solicitud_NIE.pdf' }
    ],
    where: [
      { name: 'Comisaría de Policía (cita previa)', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
    ],
  ...
  },
  {
    ...
    forms: [
      { name: 'Formulario EX-03', url: 'https://extranjeros.inclusion.gob.es/es/ModelosSolicitudes/Mod_solicitudes2/03-Formulario_solicitud_trabajo_por_cuenta_ajena.pdf' }
    ],
    where: [
  ...
  },
  {
    ...
    forms: [
      { name: 'Formulario EX-07', url: 'https://extranjeros.inclusion.gob.es/es/ModelosSolicitudes/Mod_solicitudes2/07-Formulario_solicitud_trabajo_por_cuenta_propia.pdf' }
    ],
    where: [
      { name: 'Oficina de Extranjería de Barcelona', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
    ],
  ...
  },
  {
    ...
    forms: [
      { name: 'Formulario EX-18', url: 'https://extranjeros.inclusion.gob.es/es/ModelosSolicitudes/Mod_solicitudes2/18-Formulario_solicitud_registro_ciudadano_UE.pdf' }
    ],
    where: [
      { name: 'Comisaría de Policía (cita previa)', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
    ],
