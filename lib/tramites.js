export const TRAMITES = [
  {
    ...
    time: '3–6 meses',
    time_i18n: { en: '3–6 months', ca: '3–6 mesos', ar: '3-6 أشهر', zh: '3-6个月' },
    ...
    i18n: {
      en: {
        ...
        forms: [
          { name: 'Form EX-01', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex01-formulario-autorizacion-de-residencia-temporal-no-lucrativa' },
          { name: 'Tax form 790 code 052', url: 'https://sede.administracionespublicas.gob.es/tasasPDF/prepareProvincia?idModelo=790&idTasa=052' }
        ],
        where: [
      ...
      ca: {
        ...
        forms: [
          { name: 'Formulari EX-01', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex01-formulario-autorizacion-de-residencia-temporal-no-lucrativa' },
          { name: 'Taxa model 790 codi 052', url: 'https://sede.administracionespublicas.gob.es/tasasPDF/prepareProvincia?idModelo=790&idTasa=052' }
        ],
        where: [
      ...
      ar: {
        ...
        forms: [
          { name: 'نموذج EX-01', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex01-formulario-autorizacion-de-residencia-temporal-no-lucrativa' },
          { name: 'رسم نموذج 790 رمز 052', url: 'https://sede.administracionespublicas.gob.es/tasasPDF/prepareProvincia?idModelo=790&idTasa=052' }
        ],
        where: [
      ...
      zh: {
        ...
        forms: [
          { name: 'EX-01表格', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex01-formulario-autorizacion-de-residencia-temporal-no-lucrativa' },
          { name: '790税单（代码052）', url: 'https://sede.administracionespublicas.gob.es/tasasPDF/prepareProvincia?idModelo=790&idTasa=052' }
        ],
        where: [
  ...
  },
  {
    ...
    time: '1–3 meses',
    time_i18n: { en: '1–3 months', ca: '1–3 mesos', ar: '1-3 أشهر', zh: '1-3个月' },
    ...
    i18n: {
      en: {
        ...
        forms: [
          { name: 'Form EX-17', url: 'https://www.inclusion.gob.es/documents/410169/2156469/17-Formulario_TIE.pdf' },
          { name: 'Tax form 790 code 012', url: 'https://sede.policia.gob.es/Tasa790_012/' }
        ],
        where: [
      ...
      ca: {
        ...
        forms: [
          { name: 'Formulari EX-17', url: 'https://www.inclusion.gob.es/documents/410169/2156469/17-Formulario_TIE.pdf' },
          { name: 'Taxa model 790 codi 012', url: 'https://sede.policia.gob.es/Tasa790_012/' }
        ],
        where: [
      ...
      ar: {
        ...
        forms: [
          { name: 'نموذج EX-17', url: 'https://www.inclusion.gob.es/documents/410169/2156469/17-Formulario_TIE.pdf' },
          { name: 'رسم نموذج 790 رمز 012', url: 'https://sede.policia.gob.es/Tasa790_012/' }
        ],
        where: [
      ...
      zh: {
        ...
        forms: [
          { name: 'EX-17表格', url: 'https://www.inclusion.gob.es/documents/410169/2156469/17-Formulario_TIE.pdf' },
          { name: '790税单（代码012）', url: 'https://sede.policia.gob.es/Tasa790_012/' }
        ],
        where: [
  ...
  },
  {
    ...
    time: '3–8 meses',
    time_i18n: { en: '3–8 months', ca: '3–8 mesos', ar: '3-8 أشهر', zh: '3-8个月' },
    ...
    i18n: {
      en: {
        ...
        forms: [
          { name: 'Form EX-02', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex02-autorizacion-de-residencia-temporal-por-reagrupacion-familiar-definitivo-l-inclusivo-' }
        ],
        where: [
          { name: 'Immigration Office of Barcelona', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
        ],
      ...
      ca: {
        ...
        forms: [
          { name: 'Formulari EX-02', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex02-autorizacion-de-residencia-temporal-por-reagrupacion-familiar-definitivo-l-inclusivo-' }
        ],
        where: [
          { name: 'Oficina d\'Estrangeria de Barcelona', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
        ],
      ...
      ar: {
        ...
        forms: [
          { name: 'نموذج EX-02', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex02-autorizacion-de-residencia-temporal-por-reagrupacion-familiar-definitivo-l-inclusivo-' }
        ],
        where: [
          { name: 'مكتب الأجانب في برشلونة', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
        ],
      ...
      zh: {
        ...
        forms: [
          { name: 'EX-02表格', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex02-autorizacion-de-residencia-temporal-por-reagrupacion-familiar-definitivo-l-inclusivo-' }
        ],
        where: [
          { name: '巴塞罗那外国人事务办公室', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
        ],
  ...
  },
  {
    ...
    time: '1–4 semanas',
    time_i18n: { en: '1–4 weeks', ca: '1–4 setmanes', ar: '1-4 أسابيع', zh: '1-4周' },
    ...
    i18n: {
      en: {
        ...
        forms: [
          { name: 'Form EX-15', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex15-formulario-nie-y-certificados' }
        ],
        where: [
          { name: 'Police Station (prior appointment required)', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
        ],
      ...
      ca: {
        ...
        forms: [
          { name: 'Formulari EX-15', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex15-formulario-nie-y-certificados' }
        ],
        where: [
          { name: 'Comissaria de Policia (cita prèvia)', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
        ],
      ...
      ar: {
        ...
        forms: [
          { name: 'نموذج EX-15', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex15-formulario-nie-y-certificados' }
        ],
        where: [
          { name: 'مركز الشرطة (بموعد مسبق)', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
        ],
      ...
      zh: {
        ...
        forms: [
          { name: 'EX-15表格', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex15-formulario-nie-y-certificados' }
        ],
        where: [
          { name: '警察局（需提前预约）', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
        ],
  ...
  },
  {
    ...
    time: '12–36 meses',
    time_i18n: { en: '12–36 months', ca: '12–36 mesos', ar: '12-36 شهراً', zh: '12-36个月' },
    ...
    i18n: {
      en: {
        ...
        forms: [
          { name: 'Nationality application — Ministry of Justice', url: 'https://www.mjusticia.gob.es/es/ciudadanos/tramites/nacionalidad-residencia' }
        ],
        where: [
      ...
      ca: {
        ...
        forms: [
          { name: 'Sol·licitud de nacionalitat — Ministeri de Justícia', url: 'https://www.mjusticia.gob.es/es/ciudadanos/tramites/nacionalidad-residencia' }
        ],
        where: [
      ...
      ar: {
        ...
        forms: [
          { name: 'طلب الجنسية — وزارة العدل', url: 'https://www.mjusticia.gob.es/es/ciudadanos/tramites/nacionalidad-residencia' }
        ],
        where: [
      ...
      zh: {
        ...
        forms: [
          { name: '国籍申请 — 司法部', url: 'https://www.mjusticia.gob.es/es/ciudadanos/tramites/nacionalidad-residencia' }
        ],
        where: [
  ...
  },
  {
    ...
    time: '2–5 meses',
    time_i18n: { en: '2–5 months', ca: '2–5 mesos', ar: '2-5 أشهر', zh: '2-5个月' },
    ...
    i18n: {
      en: {
        ...
        forms: [
          { name: 'Form EX-03', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex03-formulario-autorizacion-de-residencia-temporal-y-trabajo-por-cuenta-ajena-o-autorizacion-de-trabajo-por-cuenta-ajena' }
        ],
        where: [
      ...
      ca: {
        ...
        forms: [
          { name: 'Formulari EX-03', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex03-formulario-autorizacion-de-residencia-temporal-y-trabajo-por-cuenta-ajena-o-autorizacion-de-trabajo-por-cuenta-ajena' }
        ],
        where: [
      ...
      ar: {
        ...
        forms: [
          { name: 'نموذج EX-03', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex03-formulario-autorizacion-de-residencia-temporal-y-trabajo-por-cuenta-ajena-o-autorizacion-de-trabajo-por-cuenta-ajena' }
        ],
        where: [
      ...
      zh: {
        ...
        forms: [
          { name: 'EX-03表格', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex03-formulario-autorizacion-de-residencia-temporal-y-trabajo-por-cuenta-ajena-o-autorizacion-de-trabajo-por-cuenta-ajena' }
        ],
        where: [
  ...
  },
  {
    ...
    i18n: {
      en: {
        ...
        forms: [
          { name: 'Form EX-07', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex07-autorizacion-de-residencia-temporal-y-trabajo-por-cuenta-propia' }
        ],
        where: [
          { name: 'Immigration Office of Barcelona', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
        ],
      ...
      ca: {
        ...
        forms: [
          { name: 'Formulari EX-07', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex07-autorizacion-de-residencia-temporal-y-trabajo-por-cuenta-propia' }
        ],
        where: [
          { name: 'Oficina d\'Estrangeria de Barcelona', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
        ],
      ...
      ar: {
        ...
        forms: [
          { name: 'نموذج EX-07', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex07-autorizacion-de-residencia-temporal-y-trabajo-por-cuenta-propia' }
        ],
        where: [
          { name: 'مكتب الأجانب في برشلونة', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
        ],
      ...
      zh: {
        ...
        forms: [
          { name: 'EX-07表格', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex07-autorizacion-de-residencia-temporal-y-trabajo-por-cuenta-propia' }
        ],
        where: [
          { name: '巴塞罗那外国人事务办公室', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_oficinas_extranjeria' }
        ],
  ...
  },
  {
    ...
    time: 'Inmediato',
    time_i18n: { en: 'Immediate', ca: 'Immediat', ar: 'فوري', zh: '立即' },
    ...
    i18n: {
      en: {
        ...
        forms: [
          { name: 'Form EX-18', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex18-formulario-inscripcion-en-el-rce-residencia-ciudadano-de-la-ue' }
        ],
        where: [
          { name: 'Police Station (prior appointment required)', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
        ],
      ...
      ca: {
        ...
        forms: [
          { name: 'Formulari EX-18', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex18-formulario-inscripcion-en-el-rce-residencia-ciudadano-de-la-ue' }
        ],
        where: [
          { name: 'Comissaria de Policia (cita prèvia)', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
        ],
      ...
      ar: {
        ...
        forms: [
          { name: 'نموذج EX-18', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex18-formulario-inscripcion-en-el-rce-residencia-ciudadano-de-la-ue' }
        ],
        where: [
          { name: 'مركز الشرطة (بموعد مسبق)', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
        ],
      ...
      zh: {
        ...
        forms: [
          { name: 'EX-18表格', url: 'https://www.inclusion.gob.es/documents/d/migraciones/ex18-formulario-inscripcion-en-el-rce-residencia-ciudadano-de-la-ue' }
        ],
        where: [
          { name: '警察局（需提前预约）', url: 'https://sede.administracionespublicas.gob.es/pagina/index/directorio/cita_previa_ciudadania' }
        ],
